...
The checked Compose topology is offline configuration evidence only. Oracle firewalling, TLS issuance,
resource behavior, object storage, backups, restore drills, and runtime isolation remain **NOT VERIFIED**
until exercised on the target.
